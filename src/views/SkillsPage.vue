    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 mt-8">
      <div class="bg-gray-100 rounded-lg p-5">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-medium">Embedded C / C++</h3>
        </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-medium">Arduino & Raspberry Pi</h3>
        </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-medium">Kotlin (Android)</h3>
        </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5 transition">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-medium">Linux Tools</h3>
        </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5 transition">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-medium">Problem Solving</h3>
        </div>
