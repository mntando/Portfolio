<template>
  ...
  <div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        ...
        <p>Writing low-level firmware for microcontrollers, optimizing performance, and interfacing with sensors and peripherals.</p>
      </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-semibold text-lg">Arduino & Raspberry Pi</h3>
        </div>
        <p>Prototyping and deploying electronics projects using various I/O devices, communication protocols, and libraries.</p>
      </div>

      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 221" class="size-5" xmlns="http://www.w3.org/2000/svg">
        ...
        <p>Developing responsive, component-driven web UIs with Vue Options API, Vue Router, and Tailwind CSS.</p>
      </div>

      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="size-5">
            <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="-11.8991" x2="40.2992" y1="48.6943" y2="-8.3222"><stop offset="0" stop-color="#1c93c1"/><stop offset=".1625" stop-color="#2391c0"/><stop offset=".4043" stop-color="#378bbe"/><stop offset=".6955" stop-color="#587eb9"/><stop offset=".9952" stop-color="#7f6cb1"/></linearGradient>
            <linearGradient id="b" gradientUnits="userSpaceOnUse" x1="43.5526" x2="95.9878" y1="149.1739" y2="94.8756"><stop offset="0" stop-color="#1c93c1"/><stop offset=".2156" stop-color="#2d8ebf"/><stop offset=".6399" stop-color="#587eb9"/><stop offset=".9952" stop-color="#7f6cb1"/></linearGradient>
            <linearGradient id="c" gradientUnits="userSpaceOnUse" x1="3.2398" x2="92.4815" y1="95.2486" y2="2.1156"><stop offset="0" stop-color="#c757a7"/><stop offset=".04551384" stop-color="#ca5a9e"/><stop offset=".2413" stop-color="#d66779"/><stop offset=".428" stop-color="#e17357"/><stop offset=".6004" stop-color="#e97c3a"/><stop offset=".7556" stop-color="#ef8324"/><stop offset=".8879" stop-color="#f28817"/><stop offset=".9819" stop-color="#f48912"/></linearGradient>
            <path d="m0 0h65.4l-65.4 64.4z" fill="url(#a)"/><path d="m128 128-63.4-65.4-64.6 65.4z" fill="url(#b)"/><path d="m0 128 128-128h-63.4l-64.6 63.7z" fill="url(#c)"/>
          </svg>
          <h3 class="font-semibold text-lg">Kotlin (Android)</h3>
        </div>
        <p>Creating native Android apps with modern architecture components, including MVVM and Jetpack libraries.</p>
      </div>

      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 255" class="size-5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <linearGradient id="a" x1="12.959359%" x2="79.638833%" y1="12.039393%" y2="78.200854%"><stop offset="0" stop-color="#387eb8"/><stop offset="1" stop-color="#366994"/></linearGradient>
            <linearGradient id="b" x1="19.127525%" x2="90.741533%" y1="20.579181%" y2="88.429037%"><stop offset="0" stop-color="#ffe052"/><stop offset="1" stop-color="#ffc331"/></linearGradient>
            <path d="m126.915866.07227555c-64.8322829.00000462-60.7837372 28.11518925-60.7837372 28.11518925l.0722755 29.1270467h61.8678717v8.7453417h-86.4415589s-41.486166-4.7049094-41.486166 60.7114618c-.00000463 65.416358 36.2100508 63.096556 36.2100508 63.096556h21.6103896v-30.355731s-1.1648552-36.210051 35.6318464-36.210051h61.3619421s34.475438.557297 34.475438-33.3190286v-56.0135516c0-.0000047 5.234323-33.89723325-62.518352-33.89723325zm-34.1140591 19.58667415c6.1553999-.0000045 11.1304351 4.9750349 11.1304351 11.1304348.000004 6.1553999-4.9750352 11.1304348-11.1304351 11.1304348-6.1553999.0000046-11.1304348-4.9750349-11.1304348-11.1304348-.0000047-6.1553999 4.9750349-11.1304348 11.1304348-11.1304348z" fill="url(#a)"/>
          ...
          <h3 class="font-semibold text-lg">Python, Flask & Django</h3>
        </div>
        <p>Building lightweight backends, APIs, and scripting tools for automation and data handling.</p>
      </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-semibold text-lg">Git & GitHub</h3>
        </div>
        <p>Version control for solo and team projects, including branch workflows, pull requests, and CI/CD basics.</p>
      </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-semibold text-lg">Linux Tools</h3>
        </div>
        <p>Comfortable with the terminal, shell scripting, and embedded Linux environments for debugging and system control.</p>
      </div>
      ...
      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          ...
          <h3 class="font-semibold text-lg">Problem Solving</h3>
        </div>
        <p>Strong analytical thinking and debugging ability, especially in system integration and cross-platform projects.</p>
      </div>

      <div class="bg-gray-100 rounded-lg p-5 hover:shadow transition">
        <div class="flex items-center gap-3 mb-2">
          <svg viewBox="0 0 72 72" xmlns="http://www.w3.org/2000/svg" class="size-6">
            <g fill="none" stroke="#000" stroke-miterlimit="10" stroke-width="3">
              <circle cx="21" cy="17" r="3"/>
              <path d="m15 30s1-4.3112 3-5.3112 4-1 6 0 3 5.3112 3 5.3112" stroke-linecap="round" stroke-linejoin="round"/>
              <circle cx="55.9917" cy="26.3237" r="3"/><path d="m49.9917 39.3237s1-4.3112 3-5.3112 4-1 6 0 3 5.3112 3 5.3112" stroke-linecap="round" stroke-linejoin="round"/>
              <circle cx="29.9928" cy="47.0078" r="3"/>
              <g stroke-linecap="round" stroke-linejoin="round">
                <path d="m23.9928 60.0078s1-4.3112 3-5.3112 4-1 6 0 3 5.3112 3 5.3112"/><path d="m52.552 20.1356c-4.219-4.9768-10.5166-8.1356-17.552-8.1356-2.7693 0-5.4243.4894-7.8832 1.3865"/><path d="m39.4332 57.5731c8.2126-1.6036 14.8614-7.5774 17.4267-15.4016"/><path d="m12.0868 32.9884c-.0575.6629-.0868 1.3338-.0868 2.0116 0 7.9743 4.0582 15.0008 10.2221 19.1268"/>
              </g>
            </g>
          </svg>
