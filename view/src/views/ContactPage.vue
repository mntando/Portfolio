  ...
  <div class="p-6 max-w-3xl mx-auto">
    ...
    <div class="rounded-xl p-6 mt-8 items-center">
      <div class="flex gap-8">
        <a href="https://github.com/yourusername" target="_blank" class="text-gray-800">
        ...
        <a href="https://linkedin.com/in/yourusername" target="_blank" class="text-blue-700">
        ...
        <a href="https://x.com/yourusername" target="_blank" class="text-gray-800">
